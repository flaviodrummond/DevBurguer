import express from 'express'; // (1) Importa o Express (ESModules). Retorna uma função que cria uma app.
import routes from './routes'; // (2) Importa o arquivo de rotas (deve exportar um Router do Express).

class App {
  // (3) Define uma classe para organizar a aplicação.
  constructor() {
    // (4) Executado ao criar 'new App()'.
